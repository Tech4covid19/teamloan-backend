package pt.teamloan.test.utils;
...
public class TokenUtils {
	...
	public static String generateTokenString(String jsonResName, Map<String, Long> timeClaims) throws Exception {
		...
		// signature
		PrivateKey pk = readPrivateKey("jwt/testPrivateKey.pem");
		return generateTokenString(pk, "jwt/testPrivateKey.pem", jsonResName, timeClaims);
	}
